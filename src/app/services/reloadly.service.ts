...
export class ReloadlyService {
  ...
  autoDetectOperator(params: any): Observable<any> {
    ...
    return this.http.post(`${this.apiUrl}/api/v1/reloadly/auto-detect-operator`, apiParams).pipe(
  ...
  getOperators(countryIso: string): Observable<any> {
    return this.http.get(`${this.apiUrl}/api/v1/reloadly/operators/${countryIso}`).pipe(
